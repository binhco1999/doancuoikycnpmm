    ...
    render() { 
        return ( 
            ...
            <div class="bg-light border-right " id="sidebar-wrapper" >
                ...
                <Link to="/report" class="list-group-item list-group-item-action "><i class="fas fa-clipboard-check"></i> Working day</Link>
                ...
                <Link to="/salary" class="list-group-item list-group-item-action "><i class="fas fa-barcode"></i> Salary</Link>
                <Link to="/calculate" class="list-group-item list-group-item-action "><i class="fas fa-barcode"></i> Calculate</Link>
                </div>
          </div>
