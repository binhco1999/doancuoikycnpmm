                       ...
                       <div>
                          ...
                          <div className="form-group row">
                            ...
                            <div className="input-group input-groupBg col-sm-9">
                              ...
                              validations={[required, vpassword]} className="form-control" id="inputPassword" placeholder="Password" />
                          ...
                          <div className="card-footer">
                            <div className="form-group row">
                              <div className="col-md-5 mt-3">
                                <a id="backtoLogin" href="/login">Back To login</a>
                              </div>
                              <div className="col-md-7 mt-1 text-right">
                                <button className="btn btn-lg font-weight-bold" id="buttonregister">Sign Up</button>
                              </div>
                            </div>
                          </div>
                        </div>
                    ...
                    {this.state.message && (
                      <div className="form-group">
                        ...
                        <div className="text-center col-md">
                          <a id="backtoLogin" href="/login">Go to Login</a>
                        </div>
                      </div>
                    )}
                    <CheckButton
